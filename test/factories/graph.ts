...
export class GraphFactory {
  static createDirectedGraphA() {
    ...
    const graph = new Graph({ vertices: new Set([a, b, c, d, e]) }, comparator)
  ...
  static createDirectedGraphB() {
    ...
    const graph = new Graph({ vertices: new Set([_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13]) }, comparator)
